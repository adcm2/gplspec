...
ax[0,0].legend([ 'Exact','Perturbed', 'Unperturbed','Exact','Perturbed', 'Unperturbed'], fontsize = MEDIUM_SIZE)
...
ax[1,0].legend(['Perturbed solution', 'Unperturbed solution'],fontsize = MEDIUM_SIZE)
...
ax[0,1].legend([ 'Exact','Perturbed', 'Unperturbed','Exact','Perturbed', 'Unperturbed'], fontsize = MEDIUM_SIZE)
...
ax[1,1].legend(['Perturbed solution', 'Unperturbed solution'],fontsize = MEDIUM_SIZE)
