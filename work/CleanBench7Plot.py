...
# potential 
ax[0].plot(dexact[:,0],dexact[:,3], "k", linewidth=3)
# ax[0].plot(d1[:, 0], d1[:, 3], "b", linewidth=3)
ax[0].plot(dp[:, 0], dp[:, 3], "b", linewidth=3)
ax[0].plot(dup[:, 0], dup[:, 3], "r--", linewidth=3)
# ax[0].plot(d2[:, c1], d2[:, c21], "r--", linewidth=3)
# ax[0].plot(d1[:, 0], d1[:, 3], "ko")
# ax[0].plot(d0[:,0],d0[:,3], "ko")
ax[0].legend([ 'Exact','Perturbed', 'Unperturbed','Nodes'], fontsize = MEDIUM_SIZE)
...
ax[1].plot(dexact[:,0],abs(dexact[:,3] - dp[:,3])/abs(max(dexact[:,3])) * 100.0, "b", linewidth=3)
ax[1].plot(dexact[:,0],abs(dexact[:,3] - dup[:,3])/abs(max(dexact[:,3])) * 100.0, "r", linewidth=3)
# ax[1].plot(d0[:,c1],abs(d0[:,c11] - d2[:,c11])/abs(max(d0[:,c11])) * 100.0, "r", linewidth=3)
# ax[1].plot(d0[:,c2],abs(d0[:,c21] - d2[:,c21])/abs(max(d0[:,c21])) * 100.0, "k", linewidth=3)
...
ax[1].legend(['Perturbed solution', 'Unperturbed solution'],fontsize = MEDIUM_SIZE)
