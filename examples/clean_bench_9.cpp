...
main() {
   ...
   std::cout << stdvec_potsol_perturb[0][0][0] << "\n";
   // variation with h:
   //    timer1.start();
   //    int lenh = 100;
   ...
   // output test
   std::string pathtofolder1 = "./work/Bench9/exact";
   std::string pathtofolder2 = "./work/Bench9/perturbed";
   std::string pathtofolder3 = "./work/Bench9/unperturbed";
